...
| User data/config/cache paths | Supported | Planned | Planned | Partially portable | Current fallback does not fully implement XDG and is not macOS-native (`shared/app_paths.py:19-34`). QStandardPaths remains an option to evaluate. |
